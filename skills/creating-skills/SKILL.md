...
description: Generates high-quality skills for the Antigravity agent environment. Use when the user wants to create a new skill or define instructions for the agent.
---
